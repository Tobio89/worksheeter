...
comprehension_questions = [
    ...
    ''',
    '''
    In the article, who said ______________________________?
    a:
    b:
    c:
    ''',
    '''
    Why does ________ think that __________________________________?
    a:
    b:
    c:
    '''
